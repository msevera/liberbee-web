...
class Input extends React.Component {
    ...
    render() {
        ...
        if (type == 'decimal')
        {
            return <DecimalFormatted className={className + cssClasses} type={type} value={!!value || typeof value == 'number' ? value: ''} onBlur={this.onBlur} onChange={this.onChange}
                                     placeholder={placeholder} disabled={disabled}/>
        }else{
            return <input className={className + cssClasses} type={type} value={!!value || typeof value == 'number' ? value: ''} onBlur={this.onBlur} onChange={this.onChange}
                          placeholder={placeholder} disabled={disabled}/>
        }
    }
}
