        ...
        switch (status){
            case 'already_confirmed': {
                return <div className="actionBlock">
                    ...
                    <div className="actionBlock--actions actionBlock--center">
                        <button className="btn btn-primary" onClick={onSkip}>{intl.formatMessage(tutorialMessages.next)}</button>
                    </div>
                </div>
            }
            ...
            default: {
                return <div className="actionBlock">
                    ...
                    <div className="actionBlock--actions actionBlock--center">
                        <a className="btn btn-primary" href="#" onClick={onSkip}>{intl.formatMessage(tutorialMessages.next)}</a>
                    </div>
                </div>
            }
        }
...
const messages = defineMessages({
    ...
    confirmEmailTitle: {
        id: 'confirmEmailStep.confirmEmailTitle',
